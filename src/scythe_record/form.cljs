...
(defn render [state]
  (fn []
    (let [wealth      (reagent/cursor state [:play :wealth])
          ...
          resolution  (reagent/cursor state [:play :resolution])
          aggressive  (reagent/cursor state [:play :aggressive])
          passive     (reagent/cursor state [:play :passive])
          ...
          resolutions (reagent/cursor state [:resolutions])
          offensive   (reagent/cursor state [:aggressive])
          defensive   (reagent/cursor state [:passive])]
      [:div
       [:div.row
       ...
       [:div.row
        [:p "The following options are for the wind gambit expansion. Leave options empty for vanilla games."]]
       [:div.row
        [:div.four.columns
         (drop-down-input "Resolution tile" resolution resolutions)]
        [:div.four.columns
         (drop-down-input "Aggressive module" aggressive offensive)]
        [:div.four.columns
         (drop-down-input "Passive module" passive defensive)]]
       [:div.row
